  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-bold text-gray-900">Rent Statistic</h2>
      ...
      <ResponsiveContainer width="100%" height={250}>
        <AreaChart data={data}>
          ...
          />
          <Area type="monotone" dataKey="value" stroke="#a3e635" strokeWidth={2} fillOpacity={1} fill="url(#colorRent)" />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  );
